...
make test                               # Testsuite (<!-- auto:tests -->278<!-- /auto:tests --> Tests), läuft ohne API-Key
...
## Stand
<!-- auto:stand -->
- fertig: 10 von 16 Paketen
- offen: WP1, WP3, WP4, WP5, WP6, WP7
- Fortschritt: 62 % — siehe [Statusseite](docs/status/index.html)
<!-- /auto:stand -->
