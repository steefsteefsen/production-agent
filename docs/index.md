...
- [demo_walkthrough/approval/README.md](demo_walkthrough/approval/README.md) – Freigabe-Seite – Browser-Check (localhost:5173/freigabe): Erzeugt mit `python scripts/ui_check/approval_check.py` bei laufender API + Vite. Konsolenfehler: **0** (0 = Pflicht). Bilder gitignored (Gu
- [demo_walkthrough/cockpit/README.md](demo_walkthrough/cockpit/README.md) – Sechs-Tab-Cockpit – Browser-Check (localhost:5173): Erzeugt mit `python scripts/ui_check/cockpit_check.py`. Konsolenfehler: **0** (0 = Pflicht). Bilder gitignored (Guardian S9).
...
- [demo_walkthrough/presentation/README.md](demo_walkthrough/presentation/README.md) – Geführte Präsentation – Browser-Check (localhost:5173/presentation): Erzeugt mit `python scripts/ui_check/presentation_check.py`. Konsolenfehler: **0** (0 = Pflicht). Bilder gitignored (Guardian S9). Dieselbe 
