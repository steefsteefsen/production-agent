...
- **01_agent_tab.png** — Agent-Tab: acht Schritt-Karten inkl. neuer Karte 7 „Beleg-Prüfung“ vor der Freigabe.
...
- **12_beleg_judge_lehnt_ab.png** — ENTSCHEIDEND: Beleg-Prüfung mit rotem Badge „✗ vom Judge nicht bestätigt“ – der Judge stützt eine Maßnahme ohne Beleg NICHT; das Badge ist auch am Freigabe-Gate sichtbar.
- **13_beleg_judge_note.png** — Freigabe-Gate zeigt die Judge-Begründung zur nicht bestätigten Maßnahme.
